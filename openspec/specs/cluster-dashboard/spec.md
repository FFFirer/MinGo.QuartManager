...
This specification defines the requirements for the cluster-level dashboard feature that provides an aggregated view of a specific cluster's jobs, agents, and scheduled tasks.
