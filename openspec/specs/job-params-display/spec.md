...
Display Job runtime parameters with type-aware rendering, manifest metadata integration, search/filter, and copy-to-clipboard functionality on the Job detail page.
