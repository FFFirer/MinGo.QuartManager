# Configurable Agent SSL

## Purpose

Allow operators to configure SSL/TLS certificate verification behavior when the Platform makes HTTP calls to Agent APIs, supporting self-signed certificates in development environments.
